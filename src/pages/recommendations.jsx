    ...
    <div className='select-none text-white'>
        ...
        <div className="text-center bg-black flex min-h-screen flex-col">
          ...
          <section className="my-auto justify-center flex rounded">
            <MapContainer center={[35.940125, 14.374125]} zoomControl={false} zoom={12} style={{ height: '82vh', width: '110vh', borderRadius: '6px'}} doubleClickZoom={false} scrollWheelZoom={false} closePopupOnClick= {false} dragging = {false} zoomSnap = {false} zoomDelta = {false} trackResize = {false} touchZoom = {false}>
              <TileLayer zIndex={1}

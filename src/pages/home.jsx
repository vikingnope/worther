    ...
    if (isDesktop) {
        ...
        return (
            <div className='select-none text-white overflow-hidden'>
                <Header choice={'home'}/>
                <div className="text-center bg-black flex min-h-screen flex-col items-center">
                    <p className="uppercase font-bold text-5xl mt-20 text-green-500">
                        Worther
                    </p>
                    ...
                    <section className='my-16'>
                        <a href='/map/light' className='uppercase text-3xl underline block w-max font-bold hover:text-cyan-300 hover:text-6xl duration-500 mb-5'>Map</a>
                        <a href='/weather' className='uppercase text-3xl underline w-max block font-bold hover:text-cyan-300 hover:text-6xl duration-500 mb-5'>Weather</a>
                        <a href='/recommendations' className='uppercase text-3xl block underline w-max font-bold hover:text-cyan-300 hover:text-6xl duration-500 mb-5'>Recommendations</a>
                        <a href='/about' className='uppercase text-3xl block underline w-max font-bold hover:text-cyan-300 hover:text-6xl duration-500'>About</a>
                    </section>
                </div>
                <Footer />
            </div>

    ...
    return (
        <div className='select-none text-white'>
            ...
            <div className="text-center bg-black flex min-h-screen flex-col items-center">
                ...
                <p className="uppercase text-3xl mt-7 mb-10 text-sky-600">
                ...
                <ul className='my-16'>
                    ...
                    <a href='/recommendations' className='uppercase text-5xl block underline w-max font-bold hover:text-cyan-300 hover:text-6xl duration-500'>Recommendations</a>
                </ul>
            </div>
            <Footer />
        </div>

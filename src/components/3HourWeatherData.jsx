          ...
          {(weather.length > 0) ?
            (
              weather.map((weather, index) => ( // * .map is used instead of loops
                ...
                <button key={index} onClick={(e) => handleSubmit(e, index)} className='duration-300 hover:cursor-pointer hover:text-4xl hover:my-6 hover:bg-cyan-800 flex border-y-2 text-white w-screen'>

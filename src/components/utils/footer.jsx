...
export const Footer = () => {
    return(
        <footer className="absolute inset-x-0 bottom-0 bg-zinc-800 h-10 w-full border-y border-zinc-600">
            <section className="relative -bottom-1.5 flex gap-x-4 justify-center">
